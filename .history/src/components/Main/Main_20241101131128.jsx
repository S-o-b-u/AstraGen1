...
const Main = () => {
  return (
    <>
      ...
      <div className="content bg-red-50 absolute left-[50%] -translate-x-[50%] top-32">
        <h1 className="text-[15vh]">Hello Deviies!</h1>
        <h2 className="text-[7vh] absolute top-16">How can i help you today :) </h2>
