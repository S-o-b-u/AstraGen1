        ...
        <>
          <div className="greet-cards relative h-32 text-center top-16 lg;top-20 ">
            ...
            <div className="cards h-72 w-[100%]  bg-red-300 justify-center lg:absolute lg:left-[50%] lg:-translate-x-[50%] text-white mt-36 lg:mt-64 flex justify-center items-center flex-wrap gap-2 lg:gap-5 ">
              <div onClick={()=>loadPrompt("Suggest beautiful places to see on an upcoming road trip.")} className="card relative transition-all text-start ease-in-out duration-300 bg-[#181B18] hover:bg-[#161816] p-5 h- lg:w-40 lg:h-[26vh] rounded-3xl ">
