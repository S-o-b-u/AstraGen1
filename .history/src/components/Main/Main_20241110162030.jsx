  ...
  return (
    <>
      ...
      {!ShowResult ? (
        ...
        <>
          <div className="result absolute left-[50%] -translate-x-[50%] top-32 flex flex-col gap-10 bg-red-400  text-white">
            <div className="user flex gap-7 items-center">
              <img
                className="w-[40px] h-[40px]"
                src=".\icons\cat.png"
                alt="user"
              />
              <p dangerouslySetInnerHTML={{ __html: RecentPrompt }} />
            </div>
            <div className="result-data flex  gap-7 items-center">
