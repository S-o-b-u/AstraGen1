...
const Main = () => {
  ...
  return (
    <>
      ...
      {!ShowResult ? (
        <>
          <div className="greet-cards bg-blue-400 w-[60%] absolute left-[50%] -translate-x-[50%] top-28 ">
            <p className="text-[15vh] px-5">
              <span>Ahoy Deviies!</span>
            </p>
            <p className="text-[4.5vh] absolute left-[50%] -translate-x-[50%] w-[100%] top-32 ">
