  ...
  return (
    <>
      ...
      {!ShowResult ? (
        ...
        <>
          <div className="result bg-red-300  w-100%  absolute px-32 top-32 flex flex-col gap-4  text-white">
            ...
            <div className="result-data mt-10 ml-1 h-72 overflow-auto flex gap-2">
