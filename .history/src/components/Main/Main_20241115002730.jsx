      ...
      {!ShowResult ? (
        <>
          <div className="greet-cards relative h-32 text-center top-16 lg;top-20 ">
            ...
            <div className="cards h-72 w-[100%]  bg-red-300 justify-center lg:absolute lg:left-[50%] lg:-translate-x-[50%] text-white top-[50%] -translate-x-0lg:mt-64 flex flex-wrap gap-2 lg:gap-5 ">
