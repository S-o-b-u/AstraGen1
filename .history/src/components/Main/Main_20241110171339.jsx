  ...
  return (
    <>
      ...
      {!ShowResult ? (
        ...
        <>
          <div className="result bg-red-300 max-h-40 absolute px-32 top-32 flex flex-col gap-4  text-white">
            <div className="user flex absolute gap-3 items-center">
              <img
            ...
            <div className="result-data absolute ml-1 flex gap-2">
              <img  className="w-[30px] h-[30px]"
                src=".\icons\chai-tea.png"
                alt="user" />
                {Loading? <MyLoader/>
                :
              <p className="flex items-center" dangerouslySetInnerHTML={{ __html: ResultData }} />
            }
            </div>
          </div>
        </>
