  ...
  return (
    <>
      ...
      {!ShowResult ? (
        ...
        <>
          <div className="result bg-blue-200 w-100% absolute px-32 top-32 flex flex-col gap-4  text-white">
            ...
            <div className="result-data  ml-1   flex gap-2">
              <img  className="w-[30px] h-[30px]"
                ...
                {Loading? <MyLoader/>
                :
              <p className="h-[58vh] overflow-auto mt-1" dangerouslySetInnerHTML={{ __html: ResultData }} />
            }
            </div>
          </div>
        </>
