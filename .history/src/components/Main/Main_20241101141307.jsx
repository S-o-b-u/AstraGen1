    ...
    <>
      ...
      <div className="content  absolute left-[50%] -translate-x-[50%] top-28 ">
        ...
        <div className="cards relative text-white mt-24 flex gap-5 ">
          <div className="card relative transition-all ease-in-out duration-200 bg-[#2c2c2c] hover:bg-[#202020] p-5 w-40 h-[26vh] rounded-3xl ">
          ...
          <div className="card relative bg-[#2c2c2c] hover:bg-[#202020] p-5 w-40 h-[26vh] rounded-3xl">
