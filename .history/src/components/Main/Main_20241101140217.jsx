  ...
  return (
    <>
      ...
      <div className="content  absolute left-[50%] -translate-x-[50%] top-28 ">
        ...
        <div className="cards text-white mt-32 flex gap-5 ">
          ...
          <div className="card bg-[#2c2c2c] p-5 w-40 rounded-3xl">
            ...
            <img  className="w-[30px] h-[30px] mt-5 ml-20" src=".\icons\brain.png" alt="" />
          </div>
          <div className="card bg-[#2c2c2c] p-5 w-40 rounded-3xl">
            <p className="text-[13px] w-24">Tell me about React js and React native</p>
            <img className="w-[30px] h-[30px] mt-5 ml-20"src=".\icons\react.png" alt="" />
          </div>
        </div>
      </div>
    </>
