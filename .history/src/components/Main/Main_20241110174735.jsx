...
const Main = () => {
  ...
  return (
    <>
      ...
      {!ShowResult ? (
        <>
          <div className="greet-cards w-[60%] bg-blue-200 absolute left-[50%] -translate-x-[50%] top-28 ">
            <p className="text-[13vh] absolute left-[50%] -translate-x-[50%] ">
              <span>Ahoy Deviies Wassup!</span>
            </p>
            <p className="text-[4.5vh] absolute  top-32 ">
            {/* What can I do for you today? Ask anything, I’m here to help!{" "} */}
            </p>
            <div className="cards absolute left-[50%] -translate-x-[50%] text-white mt-20 flex gap-5 ">
        ...
        <>
          <div className="result w-100% h-[71vh] overflow-auto absolute px-36 py-2 top-24  flex flex-col gap-4  text-white">
