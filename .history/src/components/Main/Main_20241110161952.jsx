  ...
  return (
    <>
      ...
      {!ShowResult ? (
        ...
        <>
          <div className="result absolute left-[50%] -translate-x-[50%] top-32 bg-red-400  text-white">
            <div className="user flex gap-7 justify-center">
              <img
            ...
            <div className="result-data flex  gap-7 justify-center">
