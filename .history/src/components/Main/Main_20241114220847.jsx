    ...
    <>
     ...
     <div className="relative bg-red lg:px-5 lg:py-5">
        <nav className=" flex justify-between mt-8 lg:mt-0 ">
          <h1 className="absolute animate-fadeIn text-white left-[17vw] mt-1 lg:mt-0 lg:left-[6vw] text-2xl font-semibold">
            AstraG
          </h1>
          <img
      ...
      {!ShowResult ? (
        <>
          <div className="greet-cards relative h-32 text-center top-16 lg;top-20 ">
            ...
            <div className="cards h-72 justify-center lg:absolute lg:left-[50%] lg:-translate-x-[50%] text-white mt-44 lg:mt-64 flex flex-wrap gap-2 lg:gap-5 ">
