      ...
      {!ShowResult ? (
        <>
          <div className="greet-cards relative h-32 text-center top-16 lg;top-20 ">
            ...
            <div className="cards h-72 w-[100%]  bg-red-300 lg:absolute lg:left-[50%] lg:-translate-x-[50%] text-white mt-36 lg:mt-64 flex justify-center  flex-wrap gap-2 lg:gap-5 ">
