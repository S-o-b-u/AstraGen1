...
const Main = () => {
  ...
  return (
    <>
     ...
     <div className="relative bg-red p-4 lg:px-5 lg:py-5">
        <nav className=" flex justify-between ">
          <h1 className="absolute text-white left-12 mt-1 lg:left-[6vw] text-2xl font-semibold">
            AstraG
          </h1>
          <img
      ...
      {!ShowResult ? (
        ...
        <>
          <div className="result bg-blue-200 px-5  w-100% h-[71vh] overflow-auto absolute lg:px-72 top-20 lg;top-24 py-2  flex flex-col gap-4  text-white">
      ...
      <div className="prompt flex gap-5 absolute bg-[#181B18] left-[50%] -translate-x-[50%] bottom-16  lg:bottom-16 w-[90%] lg:w-[46vw] rounded-full p-3">
        <input
      ...
      <div className="absolute text-white bottom-0 left-[50%] -translate-x-[50%]">made by sobu</div>
     </div>
    </>
  );
};
