  ...
  return (
    <>
      ...
      <div className="content  absolute left-[50%] -translate-x-[50%] top-28 ">
        ...
        <div className="cards relative text-white mt-40 flex ">
          <div className="card relative bg-[#2c2c2c] p-5 w-56 h-72 rounded-3xl ">
            <p className="text-[13px]">Suggest beautiful places to see on an upcoming road trip</p>
            <img className="w-[30px] h-[30px] mt-12 absolute right-0" src=".\icons\airplane.png" alt="" />
          </div>
          <div className="card">
