...
const Main = () => {
  ...
  return (
    <>
      ...
      {!ShowResult ? (
        <>
          <div className="greet-cards w-[65%] h-32 text-center bg-blue-200 absolute left-[50%] -translate-x-[50%] top-28 ">
            <p className="text-[13vh]">
              <span>Ahoy Deviies Wassup!</span>
            </p>
            <p className="text-[3.5vh] absolute left-[50%] -translate-x-[50%] w-[100%] top-28">
