  ...
  return (
    <>
     ...
     <div className="relative bg-red p-4 lg:px-5 lg:py-5">
      ...
      {!ShowResult ? (
        <>
          <div className="greet-cards relative h-32 text-center top-16 lg;top-20 ">
            ...
            <p className="text-[2.5vh] lg:text-[5vh] absolute mt-20 lg:mt-28 ">
            Ask anything, I’m here to help!{" "}
            </p>
            </div>
            <div className="cards justify-center lg:absolute lg:left-[50%] lg:-translate-x-[50%] text-white mt-40 lg:mt-64 flex flex-wrap gap-2 lg:gap-5 ">
      ...
      <div className="prompt flex gap-5 absolute bg-[#181B18] left-[50%] -translate-x-[50%] bottom-12  lg:bottom-16 w-[90%] lg:w-[46vw] rounded-full p-3">
        <input
