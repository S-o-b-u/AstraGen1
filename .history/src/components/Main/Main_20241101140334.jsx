    ...
    <>
      ...
      <div className="content  absolute left-[50%] -translate-x-[50%] top-28 ">
        ...
        <div className="cards relative text-white mt-32 flex gap-5 ">
          <div className="card relative bg-[#2c2c2c] p-5 w-40 rounded-3xl ">
            <p className="text-[13px] w-24">Suggest beautiful places to see on an upcoming road trip</p>
            <img className="w-[30px] h-[30px] mt-5 ml-20 absolute" src=".\icons\airplane.png" alt="" />
          </div >
          <div className="card bg-[#2c2c2c] p-5 w-40 rounded-3xl">
            ...
            <img className="w-[30px] h-[30px] mt-5 ml-20" src=".\icons\urban.png" alt="" />
          </div>
          <div className="card bg-[#2c2c2c] p-5 w-40 rounded-3xl">
            <p className="text-[13px] w-24">Brainstorm team bonding activities for our work retreat</p>
            <img  className="w-[35px] h-[35px] mt-5 ml-20" src=".\icons\brain.png" alt="" />
          </div>
          <div className="card bg-[#2c2c2c] p-5 w-40 rounded-3xl">
            <p className="text-[13px] w-24">Tell me about React js and React native</p>
            <img className="w-[35px] h-[35px] mt-5 ml-20"src=".\icons\react.png" alt="" />
          </div>
        </div>
      </div>
    </>
