    ...
    <>
     ...
     <div className="relative bg-red p-4 lg:px-5 lg:py-5">
      ...
      {!ShowResult ? (
        ...
        <>
          <div className="result bg-blue-200 px-5  w-100% h-[60vh] lg:h-[71vh] overflow-auto absolute lg:px-72 top-20 lg;top-24  flex flex-col gap-4  text-white">
      ...
      <div className="prompt flex gap-5 absolute bg-[#181B18] left-[50%] -translate-x-[50%] bottom-auto  lg:bottom-16 w-[90%] lg:w-[46vw] rounded-full p-3">
        <input
