        ...
        <>
          <div className="greet-cards w-[65%] h-32 text-center absolute left-[50%] -translate-x-[50%] top-28 ">
            ...
            <div className="cards absolute left-[50%] -translate-x-[50%] text-white mt-24 flex gap-5 ">
              <div onClick={()=>loadPrompt( <p className="text-[13px] w-24">
                  Suggest beautiful places to see on an upcoming road trip.
                </p>)} className="card relative transition-all text-start ease-in-out duration-300 bg-[#181B18] hover:bg-[#161816] p-5 w-40 h-[26vh] rounded-3xl ">
              ...
              <div className="card relative transition-all text-start ease-in-out duration-300 bg-[#181B18] hover:bg-[#161816] p-5 w-40 h-[26vh] rounded-3xl">
                <p className="text-[13px] w-24">
