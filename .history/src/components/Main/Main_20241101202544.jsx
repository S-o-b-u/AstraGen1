...
const Main = () => {
  return (
    <>
      ...
      <div className="prompt absolute bg-red-100 left-[50%] -translate-x-[50%] bottom-14 w-[46vw] rounded-full p-3">
        <input className="w-[90%] ml-5 border-none outline-none bg-transparent" type="text"  />
        <button>send</button>
