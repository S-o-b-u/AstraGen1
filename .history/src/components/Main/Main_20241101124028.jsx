...
const Main = () => {
  return (
    <div className='relative w-[100%] px-5 py-5'>
      ...
      <div className='absolute right-[6vw] top-4 bg-white w-[6vw] h-[7vh] rounded-full '>
      <img className='absolute left-[50%] -translate-x-[50%] p-1 w-12' src=".\icons\icons8-ghost.gif" alt="github" />
      </div>
