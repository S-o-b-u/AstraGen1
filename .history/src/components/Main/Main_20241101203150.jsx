    ...
    <>
      ...
      <div className="content  absolute left-[50%] -translate-x-[50%] top-28 ">
        ...
        <div className="cards relative text-white mt-24 flex gap-5 ">
          <div className="card relative transition-all ease-in-out duration-300 bg-[#18242d] hover:bg-[#202020] p-5 w-40 h-[26vh] rounded-3xl ">
          ...
          <div className="card relative transition-all ease-in-out duration-300 bg-[#243642] hover:bg-[#202020] p-5 w-40 h-[26vh] rounded-3xl">
      ...
      <div className="prompt flex gap-3 absolute bg-[#243642] left-[50%] -translate-x-[50%] bottom-14 w-[46vw] rounded-full p-3">
        <input className="w-[90%] text-white ml-3 border-none outline-none bg-transparent" type="text"  />
