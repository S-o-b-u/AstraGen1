  ...
  return (
    <>
     ...
     <div className="relative px-5 py-5">
      ...
      {!ShowResult ? (
        <>
          <div className="greet-cards bg-red-300 h-32 text-center absolute left-[50%] -translate-x-[50%] top-28 ">
            <p className="text-[6vh] lg:text-[13vh]">
              <span>Hello Deviies!</span>
            </p>
            <p className="text-[5vh] absolute left-[50%] -translate-x-[50%] w-[100%] top-32">
