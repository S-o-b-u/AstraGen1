  ...
  return (
    <>
      ...
      {!ShowResult ? (
        ...
        <>
          <div className="result bg-red-300  w-100% mb-32 h-72 absolute px-32 top-32 flex flex-col gap-4  text-white">
            ...
            <div className="result-data  ml-1 overflow-auto flex gap-2">
