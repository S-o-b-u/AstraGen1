    ...
    <>
      ...
      <div className="content  absolute left-[50%] -translate-x-[50%] top-28 ">
        ...
        <div className="cards relative text-white mt-24 flex gap-5 ">
          <div className="card relative transition-all ease-in-out duration-300 bg-[#] hover:bg-[#202020] p-5 w-40 h-[26vh] rounded-3xl ">
      ...
      <div className="prompt flex gap-3 absolute bg-[#] left-[50%] -translate-x-[50%] bottom-14 w-[46vw] rounded-full p-3">
