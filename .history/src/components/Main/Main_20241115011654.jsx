      ...
      {!ShowResult ? (
        <>
          <div className="greet-cards relative h-32 text-center top-16 lg;top-20 ">
            ...
            <div className="cards h-72 w-[100%] absolute lg:left-[50%] lg:-translate-x-[50%] text-white mt-16 mb-1 lg:mt-4 flex justify-center items-center flex-wrap gap-2 lg:gap-5 ">
