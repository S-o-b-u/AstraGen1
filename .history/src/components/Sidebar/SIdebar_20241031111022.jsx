    ...
    >
      <div className="upper">
        ...
        >
          ...
          <h1
            className={`font-semibold   text-white transition-all ease-in-out delay-[.2s] duration-[.2s] ${
      ...
      <div
        className={`recents mt-11 transition-all ease-in-out delay-[.2s] duration-[.2s] m-5 ${
