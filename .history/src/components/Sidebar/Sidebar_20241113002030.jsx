...
const Sidebar = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`recents relative mt-11 m-5 bg-red-200 h-[43vh] transition-all ease-linear duration-[.4s]  ${
      ...
      >
        ...
        {PrevPrompt.map((items, index) => {
          return (
            <div
              className={`text-white absolute flex flex-col  min-w-36 mb-1 transition-all duration-[.1s] cursor-pointer gap-3 text-sm ${
                extended
