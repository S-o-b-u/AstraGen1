    ...
    <div className="relative h-[100%] bg-[#1d1f21] inline-block">
      <div className="upper">
       ...
       <Hamburger
        ...
        <div className={`mt-12 flex bg-[#282a2c] ease-in duration-200 hover:bg-[#3e4144] mr-9 ml-2 py-2 ${extended?pr-2:null}  rounded-full  justify-center items-center gap-2`}>
