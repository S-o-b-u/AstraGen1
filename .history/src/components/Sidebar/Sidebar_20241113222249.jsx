        ...
        {PrevPrompt.map((items, index) => {
          return (
            <div
              ...
              className={`text-white rounded-full py-1 px-2 recent-content flex min-w-36 mb-2 transition-all duration-[.1s] hover:bg-slate-500 cursor-pointer gap-2 text-sm ${
                extended
