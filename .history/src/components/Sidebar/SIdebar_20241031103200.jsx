    ...
    <div className="relative h-[100%] bg-[#1d1f21] inline-block">
      <div className="upper">
       ...
       <Hamburger
        ...
        <div className={`mt-12 flex bg-[#282a2c] ease-in duration-200 hover:bg-[#3e4144] m-2 p-2  rounded-full  justify-start items-center gap-3 max-w-36`}>
          <img src=".\icons\add-fill.svg" alt="" />
         {extended? <h1 className="font-semibold  text-white">New Chat</h1>:null}
        </div>
      </div>

      <div className={`recents mt-11 transition-opacity duration-300 m-5 ${extended? "opacity-100": "opacity-0"}`}>
