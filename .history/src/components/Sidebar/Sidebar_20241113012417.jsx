  ...
  return (
    ...
    >
      <div className="upper">
        ...
        <div
        onClick={()=>newChat()}
          className={`mt-12 flex bg-[#282a2c] transition-all ease-in hover:bg-[#3e4144] m-2 cursor-pointer  rounded-full items-center p-2 gap-3 max-w-36`}
        >
        ...
        {PrevPrompt.map((items, index) => {
          return (
            <div
              ...
              className={`text-white recent-content flex min-w-36 mb-1 transition-all duration-[.1s] cursor-pointer gap-3 text-sm ${
                extended
            ...
            >
              ...
              <p className="transition-all duration-[.5s] hover:text-[#b6f391]">{items.slice(0, 18)}...</p>
            </div>
          );
        })}
      </div>
      ...
      <div className="lower m-5 absolute bottom-5 flex flex-col gap-5">
        ...
        <div className="text-white flex gap-3 ">
          ...
          <h2
            className={`transition-all ease-in-out delay-[.2s] duration-[.3s]   hover:text-[#b6f391] ${
              extended ? "opacity-100" : "opacity-0"
            }`}
          >
            Follow
