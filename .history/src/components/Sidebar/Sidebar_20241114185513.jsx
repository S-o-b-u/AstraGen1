  ...
  return (
    ...
    >
      <div className="upper">
        ...
        <div
          onClick={() => newChat()}
          className={`mt-12 flex bg-[#282a2c] transition-all ease-in hover:bg-[#3e4144] m-2 cursor-pointer  rounded-full items-center p-2 gap-3 opacity-0 lg:opacity-100 max-w-36`}
        >
          <img className="" src="./icons/add-fill.svg" alt="New chat" />
          <h1
