    ...
    <div className={`relative h-[100%] bg-[#1d1f21] transition-all ease-in-out duration-[.5s] inline-block ${extended? "w-64": "w-16"}` }>
      <div className="upper">
       ...
       <Hamburger
        ...
        <div className={`mt-12 flex bg-[#282a2c] hover:bg-[#3e4144] m-2 p-1 px-2  rounded-full  justify-start items-center gap-3 max-w-36`}>
          <img src=".\icons\add-fill.svg" alt="" />
        <h1 className={`font-semibold  text-white transition-all ease-in-out delay-[3s] duration-[1s] ${extended? "opacity-100": "opacity-0"} `}>New Chat</h1>
        </div>
      </div>
