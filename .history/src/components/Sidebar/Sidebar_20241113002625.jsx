    ...
    >
      ...
      >
        ...
        {PrevPrompt.map((items, index) => {
          return (
            <div className="recent-content overflow-auto">
              <div
              className={`text-white recent-content  bg-blue-400 flex min-w-36 mb-1 transition-all duration-[.1s] cursor-pointer gap-3 text-sm ${
                extended
