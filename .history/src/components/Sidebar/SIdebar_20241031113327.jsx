  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className={`text-white flex min-w-36 transition-all duration-[.1s]  gap-3 text-sm ${extended? " delay-300 transition-opacity blur-none opacity-100":"blur-sm transiti opacity-0"}`}>
