  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className={`text-white flex min-w-36 transition-all duration-[.1s]  gap-3 text-sm ${extended? " delay-300 duration-1000 blur-none opacity-100":"blur-sm opacity-0"}`}>
