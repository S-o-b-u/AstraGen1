    ...
    <div className="relative h-[100%] bg-[#1d1f21] inline-block">
      <div className="upper">
       ...
       <Hamburger
        ...
        <div className={`${extended? "mt-12 flex bg-[#282a2c] ease-in duration-200 hover:bg-[#3e4144] m-2 p-2  rounded-full  justify-start items-center gap-3 max-w-36": "invisible" }`}>
