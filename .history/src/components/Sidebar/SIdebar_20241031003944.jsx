...
const [extended, setextended] = useState(fals)
  return (
    <div className="relative h-[100%] bg-[#1d1f21] inline-block">
      <div className="upper">
       ...
       <Hamburger
        ...
        <div className={`mt-12 flex bg-[#282a2c] ease-in duration-200 hover:bg-[#3e4144] m-3 p-2  rounded-full  justify-center items-center gap-2 max-w-36`}>
