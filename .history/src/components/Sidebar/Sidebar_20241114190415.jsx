  ...
  return (
    ...
    >
      <div className="upper">
        ...
        >
          <img className="p-2" src="./icons/add-fill.svg" alt="New chat" />
          <h1
      ...
      <div className="lower m-5 absolute bottom-5 flex flex-col gap-5">
        ...
        <a href="">
          <div className="text-white flex gap-3 ">
            <img className={`transition-all ease-in-out delay-[.2s] duration-[.2s] ${extended? "opacity-100" : "opacity-0 lg:opacity-100"}`} className="opacity-0 lg:opacity-100"  src=".\icons\help.svg" alt="" />
            <h2
              className={`transition-all ease-in-out delay-[.2s] duration-[.2s]  hover:text-[#b6f391]  ${
                extended ? "opacity-100" : "opacity-0"
              }`}
        ...
        <a href="https://github.com/S-o-b-u/AstraGen1/pulls">
          <div className="text-white flex gap-3 ">
            <img  className="opacity-0 lg:opacity-100"  src=".\icons\contri.svg" alt="" />
            <h2
              className={`transition-all ease-in-out delay-[.2s] duration-[.2s]  hover:text-[#b6f391] ${
                extended ? "opacity-100" : "opacity-0"
              }`}
