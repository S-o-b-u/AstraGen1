      ...
      <div className="upper">
       ...
       <Hamburger
        ...
        <div className={`mt-12 flex bg-[#282a2c] hover:bg-[#3e4144] m-2 p-2  rounded-full  justify-start items-center gap-3 max-w-36`}>
         ...
         {extended? <h1 className={`font-semibold  text-white duration-[.s] ${extended? "opacity-100": "opacity-0"} `}>New Chat</h1>:null}
        </div>
      </div>

      <div className={`recents mt-11 transition-opacity duration-[.s] m-5 ${extended? "opacity-100": "opacity-0"}`}>
